...
case 5: JOptionPane.showMessageDialog(null," " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/Errorbanco.jpg",160,165));saldo1+=100;lab.setText(String.valueOf(saldo1));break;
...
case 1:  c =  JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/safari.png",150,165));
       
int res1=0;
if(saldoJ>=60){ 
if(c==0){jf.Prt1.setText(j);
  
JOptionPane.showMessageDialog(null, "comprado");
res1=saldoJ-60;
lab.setText(String.valueOf(res1));};saldoJ=res1;}else { JOptionPane.showMessageDialog(null,"no te alncanza el dinero");}break;

case 2:  randomTJ(saldoJ,lab);break;

case 3:  c = JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/aurora.png",150,165));     
int res3=0;
if(saldoJ>=60){
if(c==0){jf.Prt3.setText(j);

JOptionPane.showMessageDialog(null, "comprado");
 res3=saldoJ-60;
lab.setText(String.valueOf(res3));};saldoJ=res3;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 4:  break;
       
case 5:   c= JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/taxi1.jpg",150,165));        
int res5=0;
if(saldoJ>=200){
if(c==0){jf.Prt4.setText(j);

JOptionPane.showMessageDialog(null, "comprado");
        res5=saldoJ-200;
        lab.setText(String.valueOf(res5));};saldoJ=res5;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 6:   c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/sanJose.png",150,165));   
int res6=0;
if(saldoJ>=100){
if(c==0){jf.Prt5.setText(j);

JOptionPane.showMessageDialog(null, "comprado");
 res6=saldoJ-100;
lab.setText(String.valueOf(res6));};saldoJ=res6;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 7:  randomTJ(saldoJ,lab);break;

case 8:   c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/puertoQ.png",150,165));  
int res8=0;
if(saldoJ>=100){
if(c==0){jf.Prt8.setText(j);

JOptionPane.showMessageDialog(null, "comprado");
 res8=saldoJ-100;
lab.setText(String.valueOf(res8));};saldoJ=res8;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");}break;

case 9:   c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/puertoB.png",150,165));     
int res9=0;
if(saldoJ>=120){
if(c==0){jf.Prt9.setText(j);

JOptionPane.showMessageDialog(null, "comprado");
res9=saldoJ-120;
lab.setText(String.valueOf(res9));};saldoJ=res9;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 10: break;

case 11: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/antigua.png",150,165));
int res11=0;
if(saldoJ>=140){
if(c==0){jf.Prt11.setText(j);JOptionPane.showMessageDialog(null, "comprado");
      res11=saldoJ-140;
     lab.setText(String.valueOf(res11));};saldoJ=res11;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 12: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/luz.jpg",150,165));
int res12=0;
if(saldoJ>=200){
if(c==0){jf.Prt12.setText(j);JOptionPane.showMessageDialog(null, "comprado");
 res12=saldoJ-200;
lab.setText(String.valueOf(res12));};saldoJ=res12;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;
     
case 13: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/mateoF.png",150,165));
int res13=0;
if(saldoJ>=140){
if(c==0){jf.Prt13.setText(j);JOptionPane.showMessageDialog(null, "comprado");
 res13=saldoJ-140;
lab.setText(String.valueOf(res13));};saldoJ=res13;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 14: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/castF.png",150,165));
int res14=0;   
if(saldoJ>=160){
if(c==0){jf.Prt14.setText(j);JOptionPane.showMessageDialog(null, "comprado");
     res14=saldoJ-160;
    lab.setText(String.valueOf(res14));}; saldoJ=res14;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 15: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/taxi1.jpg",150,165));
int res15=0;
if(saldoJ>=200){
if(c==0){jf.Prt15.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res15=saldoJ-200;
lab.setText(String.valueOf(res15));};saldoJ=res15;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 16: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/desp.png",150,165));
int res16=0;
if(saldoJ>=180){
if(c==0){jf.Prt16.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res16=saldoJ-180;
lab.setText(String.valueOf(res16));};saldoJ=res16;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 17: randomTJ(saldoJ,lab);break;

case 18: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/cemaco.png",150,165));
int res18=0;
if(saldoJ>=180){
if(c==0){jf.Prt18.setText(j);JOptionPane.showMessageDialog(null, "comprado");
 res18=saldoJ-180;
lab.setText(String.valueOf(res18));};saldoJ=res18;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 19: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/megap.png",150,165));
int res19=0;
if(saldoJ>=200){
if(c==0){jf.Prt19.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res19=saldoJ-200;
lab.setText(String.valueOf(res19));};saldoJ=res19;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 20: break;   

case 21: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/campero.png",150,165));
int res21=0;
if(saldoJ>=220){
if(c==0){jf.Prt21.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res21=saldoJ-220;
lab.setText(String.valueOf(res21));};saldoJ=res21;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 22: randomTJ(saldoJ,lab);break;

case 23: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/india.png",150,165));
int res23=0;
if(saldoJ>=220){
if(c==0){jf.Prt23.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res19=saldoJ-220;
lab.setText(String.valueOf(res23));};saldoJ=res23;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 24: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/gallo.png",150,165));
int res24=0;
if(saldoJ>=240){
if(c==0){jf.Prt24.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res24=saldoJ-240;
lab.setText(String.valueOf(res24));};saldoJ=res24;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;


case 25: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/taxi1.jpg",150,165));
int res25=0;
if(saldoJ>=200){
if(c==0){jf.Prt25.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res25=saldoJ-200;
lab.setText(String.valueOf(res25));};saldoJ=res25;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;


case 26: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/pradera.png",150,165));
int res26=0;
if(saldoJ>=260){
if(c==0){jf.Prt26.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res26=saldoJ-260;
lab.setText(String.valueOf(res26));};saldoJ=res26;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;  

case 27: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/miraF.png",150,165));
int res27=0;
if(saldoJ>=260){
if(c==0){jf.Prt27.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res27=saldoJ-260;
lab.setText(String.valueOf(res27));};saldoJ=res27;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;

case 28: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/agua.jpg",150,165));
int res28=0;
if(saldoJ>=200){
if(c==0){jf.Prt28.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res28=saldoJ-200;
lab.setText(String.valueOf(res28));};saldoJ=res28;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;
 

case 29: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/tikal.png",150,165));
int res29=0;
if(saldoJ>=280){
if(c==0){jf.Prt29.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res29=saldoJ-280;
lab.setText(String.valueOf(res29));};saldoJ=res29;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;
...
case 31: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/petapa.png",150,165));
int res31=0;
if(saldoJ>=300){
if(c==0){jf.Prt31.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res31=saldoJ-300;
lab.setText(String.valueOf(res31));};saldoJ=res31;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;


case 32: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/xetulul.png",150,165));
int res32=0;
if(saldoJ>=300){
if(c==0){jf.Prt32.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res32=saldoJ-300;
lab.setText(String.valueOf(res32));};saldoJ=res32;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;


case 33: randomTJ(saldoJ,lab);break;

case 34: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/xocomil.png",150,165));
int res34=0;
if(saldoJ>=320){
if(c==0){jf.Prt34.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res34=saldoJ-320;
lab.setText(String.valueOf(res34));};saldoJ=res34;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;


case 35: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/taxi1.jpg",150,165));
int res35=0;
if(saldoJ>=200){
if(c==0){jf.Prt35.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res35=saldoJ-200;
lab.setText(String.valueOf(res35));};saldoJ=res35;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;


case 36: randomTJ(saldoJ,lab);break;

case 37: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/atitlan.png",150,165));
int res37=0;
if(saldoJ>=350){
if(c==0){jf.Prt37.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res37=saldoJ-350;
lab.setText(String.valueOf(res37));};saldoJ=res37;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;


case 38:     

case 39: c=JOptionPane.showConfirmDialog(null,"DESEA_COMPRAR?","xd",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE ,icono("/tarjetas/tikalRuina.png",150,165));
int res39=0;
if(saldoJ>=400){
if(c==0){jf.Prt39.setText(j);JOptionPane.showMessageDialog(null, "comprado");
res39=saldoJ-400;
lab.setText(String.valueOf(res39));};saldoJ=res39;}else{JOptionPane.showMessageDialog(null,"no te alncanza el dinero");};break;
...
if(!p1.equals(j)){ 
  ...
  int res1=0;res1=saldoJ-2;lab.setText(String.valueOf(res1)); 
}else{
...
int res3=0;res3=saldoJ-4;lab.setText(String.valueOf(res3));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
int res5=0;res5=saldoJ-100;lab.setText(String.valueOf(res5)); 
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p5.equals(j)){
    ...
    JOptionPane.showMessageDialog(null, "debes pagar Q6 a"+p5); int res6=0;res6=saldoJ-6;lab.setText(String.valueOf(res6));  
...
if(!p8.equals(j)){
    ...
    int res8=0;res8=saldoJ-6;lab.setText(String.valueOf(res8));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
int res9=0;res9=saldoJ-8;lab.setText(String.valueOf(res9));       
}else{
...
if(!p11.equals(j)){
    ...
    int res11=0;res11=saldoJ-10;lab.setText(String.valueOf(res11));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p12.equals(j)){
    ...
    int res12=0;res12=saldoJ-100;lab.setText(String.valueOf(res12));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p13.equals(j)){
    ...
    int res13=0;res13=saldoJ-10;lab.setText(String.valueOf(res13));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p14.equals(j)){
    ...
    int res14=0;res14=saldoJ-12;lab.setText(String.valueOf(res14));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p15.equals(j)){
    ...
    int res15=0;res15=saldoJ-100;lab.setText(String.valueOf(res15));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p16.equals(j)){
    ...
    int res16=0;res16=saldoJ-14;lab.setText(String.valueOf(res16));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p18.equals(j)){
    ...
    int res18=0;res18=saldoJ-14;lab.setText(String.valueOf(res18));
...
if(!p19.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/megap.png",160,165));
      ...
      int res19=0;res19=saldoJ-16;lab.setText(String.valueOf(res19));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p21.equals(j)){
    ...
    int res21=0;res21=saldoJ-18;lab.setText(String.valueOf(res21));
}else{
JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/propietario.jpg",160,165)); 
};break;
...
if(!p23.equals(j)){
    ...
    int res23=0;res23=saldoJ-18;lab.setText(String.valueOf(res23));
...
if(!p24.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/gallo.png",160,165));
      ...
      int res24=0;res24=saldoJ-20;lab.setText(String.valueOf(res24));
...
if(!p25.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/taxi1.jpg",160,165));
      ...
      int res25=0;res25=saldoJ-100;lab.setText(String.valueOf(res25));
...
if(!p26.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/pradera.png",160,165));
      ...
      int res26=0;res26=saldoJ-22;lab.setText(String.valueOf(res26));
...
if(!p27.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/miraF.png",160,165));
      ...
      int res27=0;res27=saldoJ-22;lab.setText(String.valueOf(res27));
...
if(!p28.equals(j)){
    ...
    int res28=0;res28=saldoJ-100;lab.setText(String.valueOf(res28));
...
if(!p29.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/tikal.png",160,165));
      ...
      int res29=0;res29=saldoJ-24;lab.setText(String.valueOf(res29));
...
if(!p31.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/petapa.png",160,165));
      ...
      int res31=0;res31=saldoJ-26;lab.setText(String.valueOf(res31));
...
if(!p32.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/xetulul.png",160,165));
      ...
      int res32=0;res32=saldoJ-26;lab.setText(String.valueOf(res32));
...
if(!p34.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/xocomil.png",160,165));
     ...
     int res34=0;res34=saldoJ-28;lab.setText(String.valueOf(res34));
...
if(!p35.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/taxi1.png",160,165));
      ...
      int res35=0;res35=saldoJ-100;lab.setText(String.valueOf(res35));
...
if(!p37.equals(j)){
    JOptionPane.showMessageDialog(null,"  " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/atitlan.png",160,165));
     ...
     int res37=0;res37=saldoJ-35;lab.setText(String.valueOf(res37));
...
if(!p39.equals(j)){
    ...
    int res39=0;res39=saldoJ-50;lab.setText(String.valueOf(res39));
...
case 4:   JOptionPane.showMessageDialog(null," Pagas Q200 de mordida al chonte " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/chonteM.jpg",160,165));
int resChonte=0;resChonte=saldoJ-200;lab.setText(String.valueOf(resChonte));break;
...
case 38:JOptionPane.showMessageDialog(null," Invitas a los shucos, Pagas Q100 " , "xd", JOptionPane.INFORMATION_MESSAGE,icono("/tarjetas/ShucosP.jpg",160,165));
int resShuco=0;resShuco=saldoJ-100;lab.setText(String.valueOf(resShuco));break;
